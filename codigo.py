...
color_input_1 = st.sidebar.color_picker("Que color quieres para el primer gráfico?", 'green')
color_input_2 = st.sidebar.color_picker("y para el segundo gráfico?", 'blue')
